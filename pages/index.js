    ...
    <div className="font-bold text-2xl text-center my-2">Basic Information</div>
      <div className="flex flex-wrap -mx-3 mb-6">
        ...
        <div className="w-full md:w-1/2 px-3 my-3">
          ...
          <input type="file" onChange={onImageChange} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="profilepic" placeholder="choose profile pic" />
        </div>  
      </div>
