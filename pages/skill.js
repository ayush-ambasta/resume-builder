        ...
        <div className="flex justify-center">
            <form className="w-full max-w-lg" onSubmit={handleSubmit}>
                ...
                <div className="w-full md:w-1/2 px-3 my-3">
                    ...
                    <textarea cols={60} rows={10} required onChange={onchange} value={skill} className="appearance-none bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 resize" name="skill" type="text" placeholder="Use semicolon(;) to display content in separate line in resume"/>
                </div>
